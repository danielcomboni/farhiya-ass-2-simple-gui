...
import com.device.utilities.SmartphoneData;
...
public class AddSmartphonePopup extends HBox {
    ...
    public AddSmartphonePopup(Stage parentStage){
    ...
    private void saveANewTablet(){
        ...
        aSmartphone.setCameraStrength(Double.parseDouble(tabletCameraStrength));
        aSmartphone.setType(tabletType);
        aSmartphone.setName(tabletName);

        new SmartphoneData().addAnItemToStock(aSmartphone);

        SmartphoneTable.AddToTable(aSmartphone);
